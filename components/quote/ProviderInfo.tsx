              ...
              {!user && (localDetails.businessName || localDetails.phone) && (
                <div className="mt-4 p-3 bg-indigo-50 rounded-md border border-indigo-100 flex flex-col gap-2">
                    <p className="text-xs text-indigo-800">
                        ...
                        Create a free account to save your business details & GST number forever.
                    </p>
                    <Link href="/?auth=register" className="w-full">
                        <Button size="sm" variant="outline" className="w-full border-indigo-200 text-indigo-700 hover:bg-indigo-100 hover:text-indigo-800 h-8 text-xs">
                            Create Account
                        </Button>
                    </Link>
                </div>
